...
flags.DEFINE_bool("preprocess_train", True, "Preprocess training PPR propagation")
flags.DEFINE_bool(
    "preprocess_validation", True, "Preprocess validation PPR propagation"
)
flags.DEFINE_bool("preprocess_test", False, "Preprocess testing PPR propagation")
...
def run():
    ...
    split = mlp_propagate_split(
        ...
        preprocess_train=FLAGS.preprocess_train,
        preprocess_validation=FLAGS.preprocess_validation,
        preprocess_test=FLAGS.preprocess_test,
    )
